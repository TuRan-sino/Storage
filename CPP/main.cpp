...
(function () {
    ...
    (function () {
        ...
        window.bp_save_config = () => {
            ...
            if (config.rpc_domain !== old_config.rpc_domain) { // 判断RPC配置情况
    ...
    (function () {
        ...
        function download_danmaku_ass(_cid, title) {// 测试中......
            $.ajax(`https://api.bilibili.com/x/v1/dm/list.so?oid=${_cid}`, {
                ...
                success: (result) => {
                    ...
                    if (!result_dom || !result_dom.find('d')[0]) {
                        //utils.Message.warning(`${title}<br/>未发现弹幕`);
                        return;
                    } else {
                        // 1.json
        ...
        setTimeout(function () {
            ...
            if (!!$('#arc_toolbar_report')[0]) {
                my_toolbar = '' +
                    ...
                    '<span id="download_danmaku"><i class="van-icon-download"></i>下载弹幕</span>' +
                ...
                my_toolbar = '' +
                    ...
                    '<div id="download_danmaku" class="like-info"><i class="iconfont icon-download"></i><span>下载弹幕</span></div>' +
